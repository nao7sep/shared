...
# DeepSeek-specific retry timing.
DEEPSEEK_RETRY_ATTEMPTS = 10
DEEPSEEK_RETRY_MULTIPLIER = 1.0
DEEPSEEK_RETRY_MIN_SEC = 1.0

# Gemini SDK retry timing.
GEMINI_RETRY_ATTEMPTS = 5
GEMINI_RETRY_INITIAL_DELAY_SEC = 1.0
GEMINI_RETRY_EXP_BASE = 2.0
GEMINI_RETRY_JITTER = 0.5
GEMINI_RETRY_MAX_DELAY_SEC = 60.0
