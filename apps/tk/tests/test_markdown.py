...
class TestGenerateTodo:
        ...
        tasks = [
            {
                ...
                "handled_at": "2026-02-07T15:00:00+00:00",
            ...
            },
            {
                ...
                "handled_at": "2026-02-09T15:00:00+00:00",
            ...
            },
            {
                ...
                "handled_at": "2026-02-08T15:00:00+00:00",
    ...
    def test_generate_todo_tasks_within_date(self, temp_dir):
        """Test that tasks within date are sorted by handled_at."""
        output_path = temp_dir / "TODO.md"
        tasks = [
            {
                "text": "Task at 12:00",
                "status": "done",
                "created_at": "2026-02-09T10:00:00+00:00",
                "handled_at": "2026-02-09T12:00:00+00:00",
                "subjective_date": "2026-02-09",
                "note": None,
            },
            {
                ...
                "handled_at": "2026-02-09T10:00:00+00:00",
                "subjective_date": "2026-02-09",
                "note": None,
            },
        ]
    ...
    def test_generate_todo_status_emoji(self, temp_dir):
        ...
        tasks = [
            ...
            },
            {
                ...
                "status": "cancelled",
                "created_at": "2026-02-09T10:00:00+00:00",
                "handled_at": "2026-02-09T16:00:00+00:00",
                "subjective_date": "2026-02-09",
                "note": None,
            },
        ]
