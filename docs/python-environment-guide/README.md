...
Guide for managing Python installations, virtual environments, and dependencies on macOS for FastAPI development.
...
3. **03-poetry-workflow.md** - Managing dependencies with Poetry
...
- Setting up a new project? → 03-poetry-workflow.md
...
- Building FastAPI backend + React/TypeScript frontend projects
- New to Python, coming from C# background
- Want to avoid breaking system Python

## Key Principle

**Never touch system Python. Use Homebrew Python for development. Isolate project dependencies in virtual environments.**
